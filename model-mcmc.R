...
write.csv(file = "tmp/metareg_model_results.csv",model_results)
...
write.csv(file = "tmp/metareg_model_results_hedge.csv",model_results)
...
write.csv(file = "tmp/metareg_model_results_m.csv",model_results)
...
write.csv(file = "tmp/metareg_model_results_hedge_m.csv",model_results)
